...
enum AvailableCoinsType
{
    ...
    ONLY_1000 = 5, // find zeronode outputs including locked ones (use with caution)
...
public:
    ...
    // zeronode
    /// Get 1000 ZRO output and keys which can be used for the Zeronode
    bool GetZeronodeVinAndKeys(CTxIn& txinRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");
