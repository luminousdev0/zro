...
//zeronode
    ...
    const char *ZERONODEPAYMENTVOTE = "mnw";
    const char *ZERONODEPAYMENTBLOCK = "mnwb";
    const char *ZERONODEPAYMENTSYNC = "mnget";
...
const static std::string allNetMessageTypes[] = {
        ...
        NetMsgType::ZERONODEPAYMENTVOTE,
        NetMsgType::ZERONODEPAYMENTBLOCK,
        NetMsgType::ZERONODEPAYMENTSYNC,
        NetMsgType::SPORK,
...
const char* CInv::GetCommand() const
{
    ...
    switch (type)
    {
        ...
        case MSG_ZERONODE_PAYMENT_VOTE:    return NetMsgType::ZERONODEPAYMENTVOTE;
        case MSG_ZERONODE_PAYMENT_BLOCK:   return NetMsgType::ZERONODEPAYMENTBLOCK;
        case MSG_ZERONODE_ANNOUNCE:        return NetMsgType::MNANNOUNCE;
        case MSG_ZERONODE_PING:            return NetMsgType::MNPING;
        case MSG_DSTX:                  return NetMsgType::DSTX;
        case MSG_ZERONODE_VERIFY:          return NetMsgType::MNVERIFY;
        default: {
            return "error";
        }
    }
