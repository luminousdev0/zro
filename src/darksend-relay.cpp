...
CDarkSendRelay::CDarkSendRelay(CTxIn& vinZeronodeIn, vector<unsigned char>& vchSigIn, int nBlockHeightIn, int nRelayTypeIn, CTxIn& in2, CTxOut& out2)
{
    vinZeronode = vinZeronodeIn;
    vchSig = vchSigIn;
...
{
    CZeronode* pmn = mnodeman.GetZeronodeByRank(nRank, nBlockHeight, MIN_PRIVATESEND_PEER_PROTO_VERSION);
