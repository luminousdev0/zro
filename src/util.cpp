...
const char * const BITCOIN_CONF_FILENAME = "zerobitcoin.conf";
const char * const BITCOIN_PID_FILENAME = "zerobitcoind.pid";
...
#else
    const char* pszModule = "zerobitcoin";
#endif
    if (pex)
        return strprintf(
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\zerobitcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\zerobitcoin
    // Mac: ~/Library/Application Support/zerobitcoin
    // Unix: ~/.zerobitcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "zerobitcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/zerobitcoin";
#else
    // Unix
    return pathRet / ".zerobitcoin";
#endif
#endif
}
