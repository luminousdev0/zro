    ...
    platformStyle(platformStyle)
{
    ...
    zeronodeListPage = new ZeronodeList(platformStyle);
    addWidget(zeronodeListPage);
...
void WalletView::setClientModel(ClientModel *clientModel)
{
    ...
    zeronodeListPage->setClientModel(clientModel);
}
...
void WalletView::setWalletModel(WalletModel *walletModel)
{
    ...
    zeronodeListPage->setWalletModel(walletModel);
...
void WalletView::gotoZeronodePage()
{
    setCurrentWidget(zeronodeListPage);
}
